...
def test_commitments(alice, bob, operator, erc20_plasma_ct, ownership_predicate):
    ...
    assert erc20_plasma_ct.commitment_chain.verify_inclusion(commit2_alice_to_bob, erc20_plasma_ct.address, None)
    assert erc20_plasma_ct.commitment_chain.verify_inclusion(commit3_bob_to_alice, erc20_plasma_ct.address, None)
