...
def test_revoke_claim_on_deposit(alice, bob, operator, erc20_plasma_ct, ownership_predicate):
    ...
    erc20_plasma_ct.revoke_claim(10, deposit_claim_id, deprecation_witness0_alice_to_bob)
...
def test_challenge_claim_with_invalid_state(alice, mallory, operator, erc20_plasma_ct, ownership_predicate):
    ...
    erc20_plasma_ct.redeem_claim(deposit_claim_id, erc20_plasma_ct.claims[deposit_claim_id].state_update.end)
...
def test_redeem_challenged_claim(alice, mallory, operator, erc20_plasma_ct, ownership_predicate):
    ...
    erc20_plasma_ct.revoke_claim(10, revoked_claim_id, deprecation_witness0_mallory_to_alice)
    ...
    erc20_plasma_ct.redeem_claim(claim_id, erc20_plasma_ct.claims[claim_id].state_update.end)
    # Check that alice was sent her money!
